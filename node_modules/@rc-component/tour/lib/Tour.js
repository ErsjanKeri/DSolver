...
var _excluded = ["prefixCls", "steps", "defaultCurrent", "current", "onChange", "onClose", "onFinish", "open", "mask", "arrow", "rootClassName", "placement", "renderPanel", "gap", "animated", "scrollIntoViewOptions"];
var CENTER_ALIGN = {
  points: ['cc', 'cc'],
  offset: [0, 0]
};
...
var Tour = function Tour(props) {
  var _restProps$builtinPla, _restProps$builtinPla2;
  ...
  // ========================= popupAlign =========================
  var popupAlign = targetElement ? arrowPointAtCenter ? ((_restProps$builtinPla = restProps.builtinPlacements) === null || _restProps$builtinPla === void 0 ? void 0 : _restProps$builtinPla[placement]) || (0, _placements.getCenterPlacements)({
    placement: placement
  }) : ((_restProps$builtinPla2 = restProps.builtinPlacements) === null || _restProps$builtinPla2 === void 0 ? void 0 : _restProps$builtinPla2[mergedPlacement]) || _placements.default[mergedPlacement] : CENTER_ALIGN;
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_rcTrigger.default, (0, _extends2.default)({
